...
plot(T_1N,X_1N(:,1),'black',...
    ...
    T_5N,X_5N(:,1),'cyan',...
    T_6N,X_6N(:,1),'magenta');
title('Displacements: Heave of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
...
plot(T_1N,V_1N(:,1),'black',...
    ...
    T_5N,V_5N(:,1),'cyan',...
    T_6N,V_6N(:,1),'magenta');
title('Velocities: Heave of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
...
plot(T_1N,A_1N(:,1),'black',...
    ...
    T_5N,A_5N(:,1),'cyan',...
    T_6N,A_6N(:,1),'magenta');
title('Accelerations: Heave of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
...
title('Rotation: Pitch of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
ylabel('Rotation [deg]');
...
title('Spin: Pitch of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
ylabel('Spin [deg/s]');
legend('1/2 car 2 DOF','1/2 car 4 DOF',...
    'Full car 3 DOF','Full car 7 DOF');
...
title('Rate of Spin: Pitch of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
...
title('Rotation: Roll of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
ylabel('Rotation [deg]');
...
title('Spin: Roll of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
ylabel('Spin [deg/s]');
legend('Full car 3 DOF','Full car 7 DOF');
...
title('Rate of Spin: Roll of Car Hitting a Speed Bump - Newmark');
xlabel('Time [s]');
ylabel('Rate of Spin [deg/s^2]');
legend('Full car 3 DOF','Full car 7 DOF');
...
plot(T_1B,X_1B(:,1),'black',...
    ...
    T_5B,X_5B(:,1),'cyan',...
    T_6B,X_6B(:,1),'magenta');
title('Displacements: Heave of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Displacement [ft]');
legend('1/4 car 1 DOF','1/4 car 2 DOF',...
    '1/2 car 2 DOF','1/2 car 4 DOF',...
...
plot(T_1B,V_1B(:,1),'black',...
    ...
    T_5B,V_5B(:,1),'cyan',...
    T_6B,V_6B(:,1),'magenta');
title('Velocities: Heave of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Velocity [ft/s]');
legend('1/4 car 1 DOF','1/4 car 2 DOF',...
    '1/2 car 2 DOF','1/2 car 4 DOF',...
...
title('Accelerations: Heave of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Acceleration [ft/s^2]');
legend('1/4 car 1 DOF','1/4 car 2 DOF',...
    '1/2 car 2 DOF','1/2 car 4 DOF',...
...
title('Rotation: Pitch of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Rotation [deg]');
legend('1/2 car 2 DOF','1/2 car 4 DOF',...
    'Full car 3 DOF','Full car 7 DOF');
...
title('Spin: Pitch of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Spin [deg/s]');
legend('1/2 car 2 DOF','1/2 car 4 DOF',...
    'Full car 3 DOF','Full car 7 DOF');
...
title('Rate of Spin: Pitch of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Rate of Spin [deg/s^2]');
legend('1/2 car 2 DOF','1/2 car 4 DOF',...
    'Full car 3 DOF','Full car 7 DOF');
...
title('Rotation: Roll of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Rotation [deg]');
legend('Full car 3 DOF','Full car 7 DOF');
...
title('Spin: Roll of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Spin [deg/s]');
legend('Full car 3 DOF','Full car 7 DOF');
...
title('Rate of Spin: Roll of Car Hitting a Speed Bump - Beeman');
xlabel('Time [s]');
ylabel('Rate of Spin [deg/s^2]');
legend('Full car 3 DOF','Full car 7 DOF');