function [ Jy ] = get_Jy(FSAE_Race_Car)
    %get_Jy - A function for computing the pitch moment of inertia of 
    %   the given car model.
    %
    %   USAGE
    ...
    %
    %   OUTPUT
    %Jy                 The pitch moment of inertia of the sprung mass 
    ...
    Jy = ...
        I_chassis + FSAE_Race_Car.chassis.weight/32.174 * power(cg - FSAE_Race_Car.chassis.cg_X/12,2) +...
        I_engine + FSAE_Race_Car.power_plant.weight/32.174 * power(cg - FSAE_Race_Car.chassis.motor_X/12,2) +...
